        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <!-- Profile Edit Form -->
              <form method="post" enctype="multipart/form-data" action="../users/users-profile.php">
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    if (!empty($user_info['profile_image'])) {
                      ...
                      // If the user does not have a profile image path, display a default image
                      echo '<img src="../default_profile_image.jpg" alt="Profile" class="rounded-circle">';
                    }
                    ?>
                    <div class="pt-2">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="job" type="text" class="form-control" id="Job" value="<?php echo $jobTitle; ?>">
                  </div>
                </div>
